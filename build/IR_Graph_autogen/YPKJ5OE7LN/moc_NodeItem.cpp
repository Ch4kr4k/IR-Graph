...
void NodeItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->nodeClicked((*reinterpret_cast<std::add_pointer_t<NodeId>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (NodeItem::*)(NodeId )>(_a, &NodeItem::nodeClicked, 0))
            return;
    }
}
...
// SIGNAL 0
void NodeItem::nodeClicked(NodeId _t1)
{
